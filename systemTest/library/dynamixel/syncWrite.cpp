...
void inverseAndre( double sudutX, double sudutY, double sudutZ, double x, double y, double z, double sudutX2, double sudutY2, double sudutZ2,double x2, double y2,double z2, int speed,int no7, int no8, char gerakan,int tk1,int tk2,int tk3,int tk4,int tk5,int tk6, int x_head, int y_head){
