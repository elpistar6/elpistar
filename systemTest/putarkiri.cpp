...
void putarkiri(){
        ...
        while(f2<=90.0)
   {
        ...
        sudutY=20.5;//+sin(sudutNgurang*3.14/180);
	...
	y2=-2*sin(sudutNgurang*3.14/180);//2.4
        ...
        sudutY2=20.5;//-sin(sudutNgurang*3.14/180);
...
// ------------------  ANKAT KAKI DAN MENDARAT //
		...
		y=-2-0*sin(sudutNgurang*3.14/180);//cos(sudutNgurang*3.14/360);//2.4
                z=1;//0+0.8-0.8*cos(sudutNgurang*3.14/180);
                sudutX=2-4*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
                sudutY=20.5;//+6*sin(sudutNgurang*3.14/360);
                ...
                x2=-13.4+1*sin(sudutNgurang*3.14/180);
                ...
                sudutY2=20.5;//-4*sin(sudutNgurang*3.14/360);
...
// --------------------------- BALIKIN MIRING //
        while(f2<=90)
        {
                ...
                sudutY=20.5;//-6*sin(sudutNgurang*3.14/180);
                ...
                sudutY2=20.5;//+4*sin(sudutNgurang*3.14/180);
...
// ----------------------------- MIRING //
                while(f2<=90)
                {
                        ...
                        sudutX=-2*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
                        sudutY=20.5;//+1*sin(sudutNgurang*3.14/180);
                        ...
                        sudutX2=2*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
                        sudutY2=20.5;//+1*sin(sudutNgurang*3.14/180);
                        sudutZ2=472;//-2;//-3*(pow(sin(sudutNgurang*3.14/180),2));
                        speed=100;//cos(sudutNgurang*3.14/360);
                        inverseAndre(sudutX,sudutY,0,x,y,z,sudutX2,sudutY2,0,x2,y2,z2,speed,sudutZ,sudutZ2,'2',500,500,250,780,500,500,data_image.x_head,data_image.y_head);
...
// ------------------------ ANGKAT KAKI DAN MENDARAT/
                ...
                while(f2<=180){
                        ...
                        sudutNgurang=f2;
                        x=-13.4+2*sin(sudutNgurang*3.14/180);
                        y=1.5+0*sin(sudutNgurang*3.14/180);//- pidy;//2.4
                        z=1;//-0.4-0.4*cos(sudutNgurang*3.14/180);
			sudutX=-2-4*sin(sudutNgurang*3.14/180);//- pidx;/*(pow(sin(sudutNgurang*3.14/180),2));*/`//13
                        sudutY=20.5;//-4*sin(sudutNgurang*3.14/360);//+sin(sudutNgurang*3.14/180);
                        ...
                        y2=1.5+2*sin(sudutNgurang*3.14/180);//2.4		//3
                        z2=0;//0.4-0.4*cos(sudutNgurang*3.14/180);
                        sudutX2=2-4*sin(sudutNgurang*3.14/180);//sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
                        sudutY2=20.5;//+2*sin(sudutNgurang*3.14/360);
		...
		usleep(5000);
                ...
                while(f2<=90){
                        ...
                        z=1;//cos(sudutNgurang*3.14/180);//0
                        sudutX=-2+2*sin(sudutNgurang*3.14/180);
                        sudutY=20.5;//-4+4*sin(sudutNgurang*3.14/180);
                        ...
                        sudutY2=20.5;//+2*sin(sudutNgurang*3.14/180);
